...
plot3dmap([os.path.join(root,name) for root, top, file in os.walk(".") for name in file if "npy" in name and not "csv" in name], plotid=111, maskvalue=8000, title="X-Direction")
plt.show()
